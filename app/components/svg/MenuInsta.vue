...
const isNotHover = () => tl.reverse() // 让东海反转
onMounted(() => {
  tl = gsap.timeline().pause() // 动画一开始要先暂停, 不然一开始就有动画了
  tl
    .to('#dot', {
      duration: 0.3,
      scale: 0,
      transformOrigin: 'center',
      ease: 'sine.inOut' // 从加速到减速
    })
    .to(
      '#lens1',
      {
...
<!--
  MenuInsta.vue —— 菜单底部 Instagram 图标 SVG。

  .spin 类调用 CSS 旋转动画, 这部分的类定义在 theMenu, gsap只复杂了显示和隐藏, 文字旋转一直都有
-->
<template>
  <svg
  ...
  >
    <path
      id="lens1"
      d="M35 26.7a8.3 8.3 0 1 0 0 16.7 8.3 8.3 0 0 0 0-16.7Zm0 3.3a5 5 0 1 1 0 10 5 5 0 0 1 0-10Z"
    />
    <path
      id="lens2"
      d="M35 50.7a8.3 8.3 0 1 0 0 16.7 8.3 8.3 0 0 0 0-16.7Zm0 3.3a5 5 0 1 1 0 10 5 5 0 0 1 0-10Z"
    />
    <path
      class="fill-bg stroke-transparent transition-fill duration-500 ease-[ease] "
      d="M0 0h70v22H0zm0 48h70v22H0z"
    />
    <path
      id="box-insta"
      d="M28.3 20a8.3 8.3 0 0 0-8.3 8.3v13.4c0 4.6 3.7 8.3 8.3 8.3h13.4c4.6 0 8.3-3.7 8.3-8.3V28.3c0-4.6-3.7-8.3-8.3-8.3H28.3Zm0 3.3h13.4a5 5 0 0 1 5 5v13.4a5 5 0 0 1-5 5H28.3a5 5 0 0 1-5-5V28.3a5 5 0 0 1 5-5Z"
    />
    <path
      id="dot"
