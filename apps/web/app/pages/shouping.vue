  ...
  <div class="relative min-h-screen w-full bg-[#282a30] text-neutral-800 flex flex-col justify-between">
    ...
    <main class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex items-center justify-center py-6">
      <div class="relative w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div class="hidden lg:block absolute left-1/2 top-4 bottom-4 w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-white/20 to-transparent pointer-events-none" />
